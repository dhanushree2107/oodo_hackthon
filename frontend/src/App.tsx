        ...
        <Routes>
          ...
          <Route element={<ProtectedRoute allowedRoles={['HR_OFFICER', 'SUPER_ADMIN']} />}>
            <Route element={<DashboardLayout />}>
              ...
              <Route path="/hr/employees" element={<Navigate to="/admin/employees" replace />} />
              <Route path="/hr/attendance" element={<Navigate to="/admin/attendance" replace />} />
              <Route path="/hr/leave" element={<Navigate to="/admin/leaves" replace />} />
              <Route path="/hr/leaves" element={<Navigate to="/admin/leaves" replace />} />
              <Route path="/hr/payroll" element={<Navigate to="/admin/payroll" replace />} />
              <Route path="/hr/reports" element={<Navigate to="/admin/reports" replace />} />
            </Route>
          </Route>
